...
import camera from '../../Utils/camera'; import 
CustomMap from '../../Utils/map';
...
export default class AddNewPage {
  ...
  #initializeFormEvents() {
    ...
    this.#formElement.addEventListener('submit', async (event) => {
      ...
      await this.#presenter.submitNewReport({
        description,
        evidenceImages,
  ...
  document
    ...
    .addEventListener('click', async (event) => {
      ...
      if (this.#cameraHandler && typeof this.#cameraHandler.stopAllActiveStreams === 'function') {
...
async #storeImage(image) {
  ...
  destroy() {
    if (this.#cameraIsActive && this.#cameraHandler && typeof this.#cameraHandler.stopAllActiveStreams === 'function') {
